...
vim.opt.smarttab = true -- Use shiftwidth when tabbing at line start
...
vim.opt.showcmd = true -- Show partial command in status bar
...
vim.opt.wildignore:append({ "*/node_modules/*" }) -- Exclude node_modules from file searches
